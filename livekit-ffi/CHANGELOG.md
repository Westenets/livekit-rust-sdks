...
## [0.12.45](https://github.com/Westenets/livekit-rust-sdks/compare/rust-sdks/livekit-ffi@0.12.44...rust-sdks/livekit-ffi@0.12.45) - 2026-02-06

### Fixed

- fix the RPC race condition ([#865](https://github.com/Westenets/livekit-rust-sdks/pull/865))

### Other

- Use workspace dependencies & settings ([#856](https://github.com/Westenets/livekit-rust-sdks/pull/856))
- Upgrade protocol to v1.44.0 ([#857](https://github.com/Westenets/livekit-rust-sdks/pull/857))
- Use dedicated audio_runtime with high priority for audio capture  ([#854](https://github.com/Westenets/livekit-rust-sdks/pull/854))
- Expose participant's permission to ffi layer ([#824](https://github.com/Westenets/livekit-rust-sdks/pull/824))
- Add a request_async_id to the async requests ([#842](https://github.com/Westenets/livekit-rust-sdks/pull/842))
- Use the correct download url in webrtc-sys build. ([#825](https://github.com/Westenets/livekit-rust-sdks/pull/825))
